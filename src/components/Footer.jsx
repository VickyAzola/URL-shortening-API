...
function Footer() {
    ...
    const features = [
        {id:0, text: 'Link Shortening'},
        {id:1, text: 'Branded Links'},
        {id:2, text: 'Analytics'},
    ]

    const resources = [
        {id:3, text: 'Blog'},
        {id:4, text: 'Developers'},
        {id:5, text: 'Support'},
    ]
    ...
    return (
        <>
        <footer className='bg-neutralVeryDarkViolet lg:px-28 py-10 lg:pt-14'>
            <div className="max-w-[80rem] mx-auto lg:text-left text-center flex flex-col lg:flex-row lg:justify-between items-center lg:items-start text-white">
                <a href='/' aria-label='Logo' className="mb-4 lg:mb-0">
                ...
                >
                    <ul>
                    <li className="font-bold mb-5 mt-7 lg:mt-0">Features</li>
                    {features.map((item, index) => (
                        <li key={index}  className="text-neutralGray mb-2 hover:text-primaryCyan">
                            <a href=''>
                                {item.text}
                            </a>
                        </li>
                    ...
                    <ul>
                    <li className="font-bold mb-5 mt-7 lg:mt-0">Resources</li>
                    ...
                    <ul>
                    <li className="font-bold mb-5 mt-7 lg:mt-0">Company</li>
