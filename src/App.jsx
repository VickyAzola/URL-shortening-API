...
// state to store all the userInput and shortenedUrl in an array of objects
...
// Llamada a la API para acortar la URL
async function getShortenUrl(event) {
  event.preventDefault();
  ...
  try {
    ...
    const urlAPI =
      "https://api.tinyurl.com/create?api_token=ba1TrtWVt7nGAng8Ib8NHat5kfrqw4G80nijwTwkdc9V1UImj4KssvZ56Ppx";
    ...
    console.error("Error en la solicitud a TinyURL:", error);
  }
}
      ...
      <main className="text-[18px]">
          ...
          <section className="bg-gray-100">
            <div className="max-w-[90rem] mx-auto flex flex-col justify-center items-center md:px-12 lg:px-28 px-6 pb-8">
              {allTinyUrls.map((item, index) => (
                <div
                  key={index}
                  className="w-full flex flex-col lg:flex-row items-center lg:justify-between lg:gap-x-20 my-2 bg-white p-4 lg:px-6 rounded-lg"
                >
                  ...
                  <div className="w-full lg:w-auto flex flex-col lg:flex-row lg:items-center lg:justify-between gap-x-6">
                    ...
                    <CopyToClipboard
                      onCopy={() => onCopy(index)}
                      text={allTinyUrls[index].newLink}
                    >
                      <button
                        key={index}
                        className={`${
                          index == selected
                            ...
                            : "bg-primaryCyan hover:bg-cyan-200"
                        } mt-3 lg:mt-0 text-white w-full px-6 py-2 rounded-md`}
                      >
        ...
        <section className="text-center md:pt-8 lg:pt-16 px-6 bg-gray-100">
          <div className="md:max-w-[30rem] mx-auto">
            <h2 className="primaryDarkViolet text-3xl font-bold mb-3">
              Advanced Statistics
            </h2>
        ...
        <section
          className='bg-primaryDarkViolet h-72 lg:h-64 flex flex-col items-center justify-center 
          bg-[url("/images/bg-boost-mobile.svg")] lg:bg-[url("/images/bg-boost-desktop.svg")] bg-cover bg-no-repeat bg-right'
        >
          <div className="max-w-[90rem] mx-auto">
            <h4 className="text-white font-bold text-2xl lg:text-3xl mb-5 lg:mb-8">
